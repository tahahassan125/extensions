...
(() => {
   ...
   */
  function ensureLiveInlineStylesInRules(elements, rules) {
    /*
     * V2.2.0-A3.3
     *
  ...
  function analyzeRenderingDependencies(
    ...
    /*
     * V2.2-A3: resolve direct var() references against the
     * winning custom-property definitions. Fallback values and
     * recursive/nested variable resolution are intentionally
     * deferred to V2.2-A4/A5. Custom properties inherit through
