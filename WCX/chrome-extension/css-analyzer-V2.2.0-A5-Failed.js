...
(() => {
  ...
  /*
   * V2.2-A5: recursively resolve custom-property values.
   *
   * A4 could resolve:
   *   var(--x)
   *   var(--missing, red)
  ...
  function resolveSingleVarReference(
    ...
    if (nestedReferences.length) {
      ...
      nested = resolveValueWithVariables(
        definitionValue,
        source.winner.targetElement || element,
        targets,
        winnerLookup,
        state,
      );
  ...
  function analyzeVarResolutions(
    ...
    /* V2.2-A5: recursively resolve custom-property values, including
