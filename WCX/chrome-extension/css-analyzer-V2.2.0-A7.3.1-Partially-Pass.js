...
(() => {
  ...
  function buildInheritanceWinnerIndex(ancestorCascade) {
    const index = new Map();

    for (const winner of safeArray(ancestorCascade?.winners)) {
        ...
        if (isInheritanceResetKeyword(property, sourceValue)) {
          ...
          if (sourceComputedValue === targetValue) {
            return {
              ...
              sourceProperty: winner.property || property,
              sourceOriginalProperty: winner.originalProperty || winner.property || property,
              sourceValue,
              sourceComputedValue,
              distance,
              sourceType: "ancestor-css-wide-reset",
